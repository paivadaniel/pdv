...
<div class="mt-4" style="margin-right:25px">
    <?php
    $query = $pdo->query("SELECT * from contas_pagar where vencimento = curDate() and pago != 'Sim' order by id asc"); //podia ser pago = 'Não", porém, para evitar problema com caracteres, usei pago != 'Sim'
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <a href="index.php?pagina=contas_pagar_hoje&funcao=baixar&id=<?php echo $res[$i]['id']; ?>" title="Baixar Registro">
