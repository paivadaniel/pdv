...
//arquivo responsável por gerar o código de barras

function geraCodigoBarra($numero, $largura_codigo_barras, $altura_codigo_barras) {
    
$fino = 1;
$largo = $largura_codigo_barras;
$altura = $altura_codigo_barras;
