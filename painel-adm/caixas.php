...
<body>
    ...
    <div class="mt-4" style="margin-right: 25px">
        ...
        $query_tab = $pdo->query("SELECT * FROM caixas order by id asc"); //nome é o campo da tabela
...
if (@$_GET['funcao'] == 'editar') {
    ...
    $query_ed = $pdo->query("SELECT * FROM caixas WHERE id = '$_GET[id]'");
